...
Cell* Grid::atXY(oaInt4 x, oaInt4 y, oaInt4 layer) {
    cout << "x="<<x<<" __design_origin_x="<<__design_origin_x<<" __design_origin_y="<<__design_origin_y << endl;
    oaInt4 m = (x - __design_origin_x) / __cell_width;
    oaInt4 n = (y - __design_origin_y) / __cell_height;
