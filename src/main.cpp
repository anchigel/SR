...
int main(int argc, char** argv)
{
    //init
    cout << "=================================================" << endl;
    cout << "This is SnakeRouter, for UCLA EE 201A Fall 2013" << endl << "Authors: Yasmine Badr and Mark Gottscho" << endl;
    cout << "=================================================" << endl << endl;
    ...
    //Stick to the interface enforced by TA
    //Input: 
    /*
     * ./progName <DESIGN NAME> <ROUTED DESIGN NAME> <NETLIST FILE NAME> <DESIGN RULE VALUE FILE NAME>
                
        E.g.: ./progName INV_X1 INV_X1_routed case1.txt rule1.txt
    ...
    if (routerSuccess)
		 ...
		 delete router;
		 designRules.setMetalSpaceRule(5); //5nm spacing rule, to allow wires to be separately by only 1 grid cell
